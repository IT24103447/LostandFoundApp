...
//   4. The dev database freshly seeded (AuthService.Program.cs Development seed data) so
//      user15@example.com is present and NOT already soft-deleted by a previous run — see
//      the NOTE ON TEST-USER CONSUMPTION at the top of DeleteAccountFormTests.cs in this
//      same project/folder.
